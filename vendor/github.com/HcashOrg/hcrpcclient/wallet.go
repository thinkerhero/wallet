...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []hcutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []hcutil.Address) ([]dcrjson.ListUnspentResult, error) {
...
func (c *Client) SendToAddressAsync(address hcutil.Address, amount hcutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address hcutil.Address, amount hcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address hcutil.Address,
	amount hcutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address hcutil.Address, amount hcutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress hcutil.Address, amount hcutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress hcutil.Address, amount hcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress hcutil.Address, amount hcutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress hcutil.Address, amount hcutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress hcutil.Address, amount hcutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress hcutil.Address,
	amount hcutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[hcutil.Address]hcutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[hcutil.Address]hcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[hcutil.Address]hcutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[hcutil.Address]hcutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (hcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return hcutil.DecodeAddress(addr)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []hcutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []hcutil.Address, account string) (hcutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []hcutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []hcutil.Address) (*dcrjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (hcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (hcutil.Address, error) {
...
func (c *Client) GetNewAddressGapPolicy(account string, gapPolicy GapPolicy) (hcutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (hcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (hcutil.Address, error) {
...
func (c *Client) GetAccountAsync(address hcutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address hcutil.Address) (string, error) {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]hcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]hcutil.Address, 0, len(addrStrings))
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]hcutil.Address, error) {
...
func (c *Client) ValidateAddressAsync(address hcutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (r FutureListAccountsResult) Receive() (map[string]hcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]hcutil.Amount)
	for k, v := range accounts {
		amount, err := hcutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]hcutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]hcutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (hcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := hcutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (hcutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (hcutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (hcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (hcutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (hcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address hcutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address hcutil.Address) (hcutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address hcutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address hcutil.Address, minConfirms int) (hcutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address hcutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address hcutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address hcutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address hcutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*hcutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return hcutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address hcutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address hcutil.Address) (*hcutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *hcutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *hcutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *hcutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *hcutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *hcutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *hcutil.WIF, label string, rescan bool) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanFromAsync(privKeyWIF *hcutil.WIF, label string, rescan bool, scanFrom int) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescanFrom(privKeyWIF *hcutil.WIF, label string, rescan bool, scanFrom int) error {
...
func (c *Client) AddTicket(ticket *hcutil.Tx) error {
...
func (c *Client) SetTicketFeeAsync(fee hcutil.Amount) FutureSetTicketFeeResult {
	cmd := dcrjson.NewSetTicketFeeCmd(fee.ToCoin())
	return c.sendCmd(cmd)
}

// SetTicketFee sets the ticket fee per KB amount.
func (c *Client) SetTicketFee(fee hcutil.Amount) error {
...
func (c *Client) SetTxFeeAsync(fee hcutil.Amount) FutureSetTxFeeResult {
	cmd := dcrjson.NewSetTxFeeCmd(fee.ToCoin())
	return c.sendCmd(cmd)
}

// SetTxFee sets the transaction fee per KB amount.
func (c *Client) SetTxFee(fee hcutil.Amount) error {
...
//
// See GetInfo for the blocking version and more details.
func (c *Client) StakePoolUserInfoAsync(addr hcutil.Address) FutureStakePoolUserInfoResult {
...
func (c *Client) StakePoolUserInfo(addr hcutil.Address) (*dcrjson.StakePoolUserInfoResult, error) {
...
//
// See GetInfo for the blocking version and more details.
func (c *Client) TicketsForAddressAsync(addr hcutil.Address) FutureTicketsForAddressResult {
...
// owned by the wallet.
func (c *Client) TicketsForAddress(addr hcutil.Address) (*dcrjson.TicketsForAddressResult, error) {
